...
> 🔧 **Фикс (2026-06-13).** В шагах 9/10 несколько рукописных effect-аллелей были записаны
> на минус-цепи, из-за чего интерпретация зеркалилась у мажорных гомозигот: цвет глаз
> (rs12913832 GG → теперь корректно «голубые», было «карие»), хронотип CLOCK (rs1801260),
> витамин D GC (rs2282679). Исправлено + добавлен [`steps/strand_guard.py`](steps/strand_guard.py):
> ассерт, что каждый effect-аллель лежит на плюс-цепи позиции (GRCh37) — ловит такой класс
> ошибок автоматически. Медицинские шаги (фармакогенетика, носительство, PRS) не затронуты:
> они матчат по координате+ref/alt, а не по рукописной букве. Заземляйте трейты на известный
> фенотип (цвет глаз = удобный канареечный тест).
