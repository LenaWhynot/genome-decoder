...
сырые находки не коммитим — сырые TSV — в out/, что оставить решает пользователь.
"""
import datetime
import config
...
def run():
    ...
    L.append("5 независимых кругов (как у Григория): 1 Codex-клиника · 2 Opus-самокритика · "
